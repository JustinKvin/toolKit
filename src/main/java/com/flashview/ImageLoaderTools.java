...
public class ImageLoaderTools{
    ...
    private static ImageLoader initImageLoader(Context context) {
        ...
        .showStubImage(R.mipmap.loading_ios)//设置下载期间显示的图�?
        .showImageForEmptyUri(R.mipmap.loading_ios)//设置图片URI为空或是错误的时候显示的图片
        .showImageOnFail(R.mipmap.loading_ios)//设置图片加载/解码过程中错误时候显示的图片
        .build();
