...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    //it`l be ok if the method，setRefreshing(true) is invoked in childThread
    @Override
    ...
    protected LoadingLayout createLoadingLayout(Context context, Mode mode, AnimationStyle style,TypedArray attrs) {
        LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,style,
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // set loading animation here
        mHeaderLayout = createLoadingLayout(context, Mode.PULL_FROM_START,AnimationStyle.FLIP, a);
//        mHeaderLayout = new FrameLoadingLayout(context, Mode.PULL_FROM_START, getPullToRefreshScrollDirection(), a);
        mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END,AnimationStyle.ROTATE, a);
    ...
    public enum AnimationStyle {
        ...
        FLIP,
        /**
         * This is custom, and what is commonly used for adding frame animation.
         */
        FRAME;
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode,AnimationStyle style, Orientation scrollDirection, TypedArray attrs) {
            switch (style) {
